    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="pinjam/index.php"><i class="fas fa-book-reader mr-2"></i> Pinjam</a><hr class="bg-secondary">
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="simpan/index.php"><i class="fas fa-money-check mr-2"></i> Simpan</a><hr class="bg-secondary">
          </li>
        </ul>
      </div>
        ...
        <div class="row text-white">
          ...
          <div class="card bg-warning ml-5 mt-2" style="width: 18rem;">
            <div class="card-body">
              ...
              <h5 class="card-title">DATA SIMPAN</h5>
