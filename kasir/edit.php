...
<html lang="en">
  <head>
    ...
    <title>Edit Data Kasir | Koperasi</title>
  </head>
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-4">
        <h3><i class="fas fa-user mr-2"></i> Kasir</h3><hr>

        <div class="form-mhs mt-2">
          <h5>Edit Data Kasir</h5>

          <?php
          include '../koneksi.php';

          $kode = $_GET['kode'];
          $data = mysqli_query($con,"select * from tbl_kasir where kode_kasir='$kode'");
          ...
          <form method="post" action="update.php" class="tbl mt-4">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="kode" value="<?php echo $d['kode_kasir'] ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Nama Kasir</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="nama" value="<?php echo $d['nama_kasir'] ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Password</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="password" value="<?php echo $d['password'] ?>">
              </div>
            </div>
