            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST") {
                  ...
                  if($cari != ''){
                    $sql = "SELECT * FROM tbl_kasir where nama like '%$cari%'";
                    $query = $sql;
                    $queryJml = $sql;
                  } else {
                    $query = "SELECT * FROM tbl_kasir LIMIT $posisi, $batas";
                    $queryJml = "SELECT * FROM tbl_kasir";
                    $no = $posisi + 1;
                  }
                } else {
                  $query = "SELECT * FROM tbl_kasir LIMIT $posisi, $batas";
                ...
                if(mysqli_num_rows($sql_kasir) > 0){
                  while($d = mysqli_fetch_array($sql_kasir)) { ?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-warning ml-2 mr-2" href="edit.php?kode=<?php echo $d['kode_kasir']; ?>" role="button"><i class="far fa-edit"></i></a> 
                  </td>
                  <td>
                    <a class="btn btn-danger ml-2 mr-2" href="hapus.php?kode=<?php echo $d['kode_kasir']; ?>" role="button"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                <?php 
                  }
