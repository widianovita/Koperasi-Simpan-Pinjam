...
<html lang="en">
  <head>
    ...
    <title>Edit Data Pinjam | Koperasi</title>
  </head>
  <body>
    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-4">
        ...
        <div class="form-mhs mt-2">
          ...
          $no = $_GET['no'];
          $data = mysqli_query($con,"select * from tbl_pinjam where no_pinjam='$no'");
          while($d = mysqli_fetch_array($data)){ 
          ?>

          <form method="post" action="update.php" class="tbl mt-4">
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">No Pinjam</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="no" value="<?php echo $d['no_pinjam'] ?>">
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Jumlah Pinjam</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="jml" value="<?php echo $d['jml_pinjam'] ?>">
              </div>
            </div>
            <div class="form-group row">
