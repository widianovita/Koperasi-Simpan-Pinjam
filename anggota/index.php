            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST") {
                  ...
                  if($cari != ''){
                    $sql = "SELECT * FROM tbl_anggota where nama like '%$cari%'";
                    $query = $sql;
                    $queryJml = $sql;
                  } else {
                ...
                $sql_anggota = mysqli_query($con, $query) or die (mysqli_error($con));
                if(mysqli_num_rows($sql_anggota) > 0){
                  while($d = mysqli_fetch_array($sql_anggota)) { ?>
                <tr>
                  ...
                  <td>
                    <a class="btn btn-warning ml-2 mr-2" href="edit.php?no=<?php echo $d['no_anggota']; ?>" role="button"><i class="far fa-edit"></i></a> 
                  </td>
                  <td>
                    <a class="btn btn-danger ml-2 mr-2" href="hapus.php?no=<?php echo $d['no_anggota']; ?>" role="button"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                <?php 
                  }
