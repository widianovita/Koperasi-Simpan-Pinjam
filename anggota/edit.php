...
<html lang="en">
  <head>
    ...
    <title>Edit Data Anggota | Koperasi</title>
  </head>
  <body>
    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
        <ul class="nav flex-column ml-3 mb-5">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="index.php"><i class="fas fa-user mr-2"></i> Anggota</a><hr class="bg-secondary">
          </li>
          <li class="nav-item">
      ...
      <div class="col-md-10 p-5 pt-4">
        <h3><i class="fas fa-user mr-2"></i> Anggota</h3><hr>
        ...
        <div class="form-mhs mt-2">
          ...
          $no = $_GET['no'];
          $data = mysqli_query($con,"select * from tbl_anggota where no_anggota='$no'");
          ...
          <form method="post" action="update.php" class="tbl mt-4">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="no" value="<?php echo $d['no_anggota'] ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Nama Anggota</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="nama" value="<?php echo $d['nama'] ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Wajib</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="wajib" value="<?php echo $d['wajib'] ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Pokok</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="pokok" value="<?php echo $d['pokok'] ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="colFormLabel" class="col-sm-2 col-form-label">Saldo</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="colFormLabel" placeholder="" name="saldo" value="<?php echo $d['saldo'] ?>">
              </div>
            </div>
